...
export default function AdminAddresses() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-4 rounded-3xl border border-white/10 bg-white/5 p-5 md:flex-row md:items-end md:justify-between">
        <div>
          <h2 className="text-lg font-semibold tracking-tight">Moderação de endereços</h2>
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <div className="relative">
            ...
            <Input
              ...
              className="w-full rounded-full border-white/10 bg-white/5 pl-9 sm:w-56"
            />
          </div>
          <div className="relative">
            ...
            <Input
              ...
              placeholder="Cidade"
              className="w-full rounded-full border-white/10 bg-white/5 pl-9 sm:w-44"
            />
          </div>
        </div>
      </div>
      ...
      {isError ? (
        <div className="rounded-3xl border border-destructive/30 bg-destructive/5 p-6 text-sm text-destructive">
          <p className="font-semibold">Não foi possível carregar os endereços.</p>
      ...
      <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5">
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-16 text-muted-foreground">
            <Loader2 className="mr-2 size-5 animate-spin text-primary" /> Carregando endereços…
          </div>
        ) : addresses.length === 0 ? (
                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    {address.coverImageUrl ? (
                      ...
                      <span className="flex size-14 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/10 text-muted-foreground">
                        <MapPin size={20} />
                      </span>
                    )}
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <Button
                      ...
                      size="sm"
                      variant="outline"
                      className="gap-1.5 rounded-full border-white/15 px-3 text-xs"
                    >
