        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          <div className="relative">
            ...
            <Input
              ...
              className="w-full rounded-full border-white/10 bg-white/5 pl-9 sm:w-64"
            />
          </div>
                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    {user.avatarUrl ? (
                      ...
                      <span className="flex size-10 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/10 text-xs font-semibold">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <select
                      ...
                      className="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-medium text-foreground focus:border-primary focus:outline-none disabled:opacity-60"
                    >
