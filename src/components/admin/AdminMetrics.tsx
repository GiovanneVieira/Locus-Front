...
const METRICS: MetricDef[] = [
  ...
  },
  {
    ...
    label: "Novos Hospedagens (7 dias)",
    icon: Activity,
...
export default function AdminMetrics() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center rounded-3xl border border-border bg-secondary/50 py-20 text-muted-foreground">
