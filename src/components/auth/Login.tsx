...
import { ApiError, getApiBaseUrl, login } from "@/lib/api"
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 flex flex-col gap-6 duration-500">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Button type="button" variant="outline" className="h-11 cursor-not-allowed rounded-xl border-white/10 bg-white/5 transition-all hover:bg-white/10" disabled>
