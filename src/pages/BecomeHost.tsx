...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Acesso ao formulário de publicação, busca por endereços e gerenciamento do seu portfólio.",
  },
]
        ...
        <section className="glass-card relative overflow-hidden p-10">
          ...
          <div className="relative">
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
              Ao virar anfitrião, você desbloqueia a publicação de endereços no Locus e passa a aparecer para usuários que buscam lugares reais, com identidade e propósito.
            </p>
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {benefits.map((item) => (
                ...
                >
                  <div className="mb-3 inline-flex rounded-2xl border border-white/10 bg-background/70 p-2.5">
                ...
                <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button
                      asChild
                      variant="outline"
                      className="rounded-full border-white/15 bg-white/5 px-5"
                    >
